...
var AtButton = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtButton.__proto__ || Object.getPrototypeOf(AtButton)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__1", "anonymousState__2", "$compid__1", "loading", "lang", "formType", "openType", "sessionFrom", "sendMessageTitle", "sendMessagePath", "sendMessageImg", "showMessageCard", "appParameter", "isWEAPP", "disabled", "isWEB", "isALIPAY", "size", "type", "circle", "full", "customStyle", "className", "children"], _this.customComponents = ["AtLoading"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AtButton, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__1 = (0, _index6.default)(rootClassName, classObject, this.__props.className);
      var anonymousState__2 = (0, _index.internal_inline_style)(customStyle);
  ...
  return AtButton;
}(_component2.default), _class.$$events = ["onGetUserInfo", "onGetPhoneNumber", "onOpenSetting", "onError", "onContact", "onClick", "onSumit", "onReset"], _class.$$componentPath = "Users/zhiwei/taroProjects/booklib-mini/node_modules/taro-ui/dist/weapp/components/button/index", _temp2);
