...
var book = (_temp2 = _class = function (_Taro$Component) {
  ...
  function book() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = book.__proto__ || Object.getPrototypeOf(book)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["item", "whereFrom", "catIndex"], _this.config = {
      Component: true
...
}, _class.$$componentPath = "component/book/book", _temp2);
exports.default = book;

Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(book));