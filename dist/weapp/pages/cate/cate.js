...
var cate = (_temp2 = _class = function (_Taro$Component) {
  _inherits(cate, _Taro$Component);
  ...
  function cate() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = cate.__proto__ || Object.getPrototypeOf(cate)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__1", "height", "hasNextPage", "current"], _this.config = {
      navigationBarTitleText: '彩页',
      enablePullDownRefresh: false
    }, _this.onShareAppMessage = function () {}, _this.customComponents = ["Pic", "LoadMore"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return cate;
}(_index2.default.Component), _class.$$events = ["gotoSearch", "loadMoreData"], _class.$$componentPath = "pages/cate/cate", _temp2);
