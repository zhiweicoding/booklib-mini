...
var search = (_temp2 = _class = function (_Taro$Component) {
  ...
  function search() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = search.__proto__ || Object.getPrototypeOf(search)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.config = {
      navigationBarTitleText: '天津年鉴'
    }, _this.onShareAppMessage = function () {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return search;
}(_index2.default.Component), _class.$$events = [], _class.$$componentPath = "pages/content/content", _temp2);
